...
- Use the G17's speed boost to strafe and dodge your opponents bullets.
  ...
  - You can also use the speed boost to get up close with a high-DPS melee weapon such as a <Link href="/weapons/melee/kbar">K-bar</Link>.
...
- The G17 has very low damage per bullet and DPS, so unless the opponent runs away, they can be beaten with nearly any weapon, even a <Link href="/weapons/guns/g19">G19</Link>.
- Use a high-DPS CQC weapon such as a <Link href="/weapons/guns/arx160">ARX-160</Link> or a <Link href="/weapons/guns/micro_uzi">Micro Uzi</Link>. The accuracy will make it easier to hit your opponent. Shotguns can also work well.
...
- Hide behind cover, as the G17 has terrible obtscale DPS.

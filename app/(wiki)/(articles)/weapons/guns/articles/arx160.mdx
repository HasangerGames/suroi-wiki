...
- If you are caught up close against someone using the ARX-160, try using a SMG like the [Micro Uzi](/weapons/guns/micro_uzi) or a shotgun.
...
- v0.12.2
  - Updated world image
  - Fist positions adjusted
  - Increased gun length
- v0.11.0
  - Updated world image
- v0.10.0
  - Added

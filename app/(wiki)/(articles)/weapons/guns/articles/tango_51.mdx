...
# Obtaining
The most reliable way to get a Tango 51 is to head for the ship at the port at the beginning of the game. After collecting the [Gas Can] (/weapons/melee/gas_can) on the ship, use the generator to open the vault. There will either be a crate that contains up to two Tango 51s or an A.E.G.I.S. crate. The Tango 51 can also be found extremely rarely from common sources.

The **Medikit** is a consumable that heals 100 health, and was added in the v0.4.0 "Supplies received" update on June 17th, 2023. They spawn rarely around the map. To use a Medikit, either click on the icon in your inventory or press 6 on your keyboard. Gauze takes 6 seconds to use.
...
- The Medikit is more effcient than Gauze, especially if you are low on health.
...
- If you're in a fight and you think your opponent is low enough that they are trying to use a Medikit, keep being agressive and attack them. Don't give them the chance to use a Medikit.

## Obtaining
Medikits are most commonly found in Toilets and in the Porta-Potty. They can also be found veyr rarely from crates or as ground loot.

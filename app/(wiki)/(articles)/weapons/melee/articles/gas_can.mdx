...
# Obtaining
The only way to obtain the Gas Can is to head to the ship in the Port structure and go inside the bridge, which has the Gas Can at the center of the room.

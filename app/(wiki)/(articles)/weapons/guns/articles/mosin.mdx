...
# Obtaining
The Mosin-Nagant is an uncommon drop from higher-tier crates such as the A.E.G.I.S crate and airdrops. It can also be found rarely as world loot. It can also be found rarely as world loot. It has a guaranteed drop chance from the golden rock, which always spawns once per map.

...
- The Christmas Tree also drops decent [loot](/loot#christmas_tree).
...
- If an enemy is hiding behind the tree, it is not a good idea to try and destroy it especially if it is at full health. You'll just be wasting your ammo. Instead, try to chase them out of their cover.

...
# Loot & More
The Crane itself does not have any loot, but it does have a large number of AEGIS and Flint crates underneath it which are great sources of loot.

# Tips
- The parts of the base of the crane are indestrucible, and can be used to take cover from opponents.

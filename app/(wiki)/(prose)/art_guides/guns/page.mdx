...
handle area, showing that it's possible to get creative with how one places their
splits. The muzzle flash is also considerably longer than it is high, which is a
theme amongst sniper rifles.

...
The **Bomed Armory** is a reimagining of the Armory added in the [v0.20.0](https://github.com/HasangerGames/suroi/releases/tag/v0.20.0) "Open Season" update on October 27th, 2024. It contains two unique weapons, the [USAS-12](/weapons/guns/usas12), and the [Maul](/weapons/melee/maul), and even more unique obstacles.
...
The Barracks spawns in the lower left of the Armory. It contains five [Bunk Beds](/obstacles/bunk_bed), the loot of two destroyed [Cabinets](/obstacles/cabinet) are on the ground, two small [Drawers](/obstacles/drawers), a [Stove](/obstacles/stove), and a [Fridge](/obstacles/fridge).

## Center

The Center spawns on the right side of the Armory. It contains two [Chairs](/obstacles/chair), a [Table](/obstacles/table), loot of a destroyed Cabinet, a small drawer, and loot of a destroyed [Gun Mount](/obstacles/gun_mounts) always containing a [Maul](/weapons/melee/maul).
...
Where the door of the regular Armory would be, there is instead a cracked wall, which can be broken with the [Maul](/weapons/melee/maul). There is the loot of one destroyed [Gun Case](/obstacles/gun_case), two [Ammo Crates](/obstacles/ammo_crate), a panel with no button, a [Tear Gas Crate](/obstacles/tear_gas_crate), and a [Grenade Crate](/obstacles/grenade_crate).

### Inner Vault

Once you hit the cracked wall 10 times with the Maul, it will reveal the Inner Vault, which has a [Briefcase](/obstacles/briefcase), surrounded by two Barrels, you'll need to damage or destroy the Barrels to access the Briefcase.

There are 3 boxes, and 1 crate in the Vault.

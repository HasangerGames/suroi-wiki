...
- The M3K has the longest range out of any shotgun, as well as great accuracy. Use this to avoid close confrontations with higher-DPS weapons. 
  - A good strategy is to find an obstacle such as a rock and "peek out" to fire a shot, and then keep hiding. This will avoid much of the damage from weapons such as assault rifles and DMRs.
...
- The M3K's long-range also pairs well with a sniper, if you quickswitch both. This is great if you can't find another sniper.
...
- In real life, the M3K has a magazine capacity of 10 
  - It is unknown why a Surian only loads 9 rounds
  - It may be because of the SPAS-12 in surviv.io only loading 9 rounds

...
# Location
Trees are extremely common and can spawn just about anywhere on the map. Birch and pine trees are rarer than oak trees, making them harder to find.

# Trivia

# History
- v0.9.1
    - Increased trunk radius by 2.5 (from 3)

...
- If you hit both shots with most of the pellets, it will kill or seriously weaken an opponent. Carry a secondary weapon such as an assault rifle to finish them off.
...
- Be very careful with your shots, as the Flues does not tolerate errors with only 2 rounds and its long reload time.
- The Flues is very dangerous when the safe zone is very small or in tight spaces such as buildings.

## Countering
- The Flues has the shortest range of any shotgun, tied with the [HP18](/weapons/guns/hp18), so keep your distance and don't get too close.

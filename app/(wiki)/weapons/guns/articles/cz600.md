...
- Unlike other sniper rifles, the CZ-600's fast fire rate allows it to be played more similarily to a DMR instead of quickswitching each shot. However, this requires aim and can leave you vulnerable, so it is generally advised not to utilize this strategy in most circumstances.

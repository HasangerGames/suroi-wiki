The **Bush** is an [Obstacle](/obstacles) that spawns frequently around the map. It was added to the game in the v0.1.0 "We're back, baby" update on May 20th, 2023. They are mostly opaque and can be moved through. The **Blueberry Bush** is a larger and opaque varation of the standard Bush, and contains loot underneath.
    ...
    images={[
        {
            ...
            author: "Katloo",
            caption: "A fellow Surian trying to hide in a bugged Blueberry Bush in v0.8.0"
        },
        {

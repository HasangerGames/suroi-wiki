...
- In real life, Generators are machines that convert potential, kinetic, or chemical energy into electrcity. The Generator in suroi is a fuel-based generator since it requires Gas to operate
# History
- v0.11.0
    - Added
  ...
  return (
    <main className="col-span-8 text-white">
      <div className="prose prose-invert">
        <h1>Armor</h1>
        <p>
          There are currently {Armors.definitions.length} unique pieces of armor
          in the game. These include {Helmets.length} helmets along with{" "}
          {Vests.length} vests.
        </p>
        <p>

...
# Strategies
## Using
- The MP40 is useful early game against unarmored players or players with lower tier armor. However, later in a round it becomes less effective due to the lower DPS and better armors of other players. It is a good idea to replace the MP40 with an assault rifle such as the [AK-47](weapons/guns/ak47) or [AUG](weapons/guns/aug).
...
- Shotguns work very well against a MP40 user at close-range.
...
# Obtaining
The MP40 is a common drop from crates as well as special crates and is overall one of the most easily obtainable guns in the game.

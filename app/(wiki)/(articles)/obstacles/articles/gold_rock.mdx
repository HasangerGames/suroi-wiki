...
Only one Gold Rock spawns per map.
    - The Gold Rock is not visible on the minimap.
...
Unless you have a LMG, it's likely not worth it to try and destory the Gold Rock if a player is hiding behind it, due to the large amount of health it has.

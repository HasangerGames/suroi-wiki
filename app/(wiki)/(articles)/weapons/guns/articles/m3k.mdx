...
# Obtaining
The M3K is uncommon in general world loot, but fairly common in special loot such as A.E.G.S. crates.
...
- v0.8.0
  - Reload time decreased to 0.55 seconds (from 0.8 seconds)

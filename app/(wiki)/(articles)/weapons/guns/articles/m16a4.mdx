...
# Strategies
# Using
- The M16 is currently one of the strongest weapons in the game due to its quick firerate.
- The burst feature allows you to output high amounts of damage and recede quickly, which means the M16A4 can stand up to autos like the [MCX Spear](weapons/guns/mcx_spear).

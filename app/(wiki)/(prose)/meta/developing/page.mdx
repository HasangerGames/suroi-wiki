...
Small changes are an exception to this and don't need review (though it is best to get approval).
...
If you want to contribute code; reach out to @kenos1 (kenos) or @Compositr on the [Suroi Discord](https://discord.gg/suroi). Or, you can simply look for simple grammar errors in the articles. Anything helps!

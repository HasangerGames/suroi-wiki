...
- Dual Model 37's are one of the most powerful combonations in the game. You can also pair the Model 37 with another shotgun such as a [M3K](/weapons/guns/m3k) or [Flues](/weapons/guns/flues) to acheive a similar effect.
- The Model 37 is extremely effective in confined spaces such as buildings.
...
## Countering
- As a shotgun, the Model 37 has a fairly short range compared to most guns. Knowing this, you can avoid behind hit by using a SMG like the [MP40](/weapons/guns/mp40) or any assault rifle from a distance.
...
# Obtaining
The Model 37 is fairly common as both ground loot as well as in places such as normal crates.
...
- v0.8.0
  ...
  - Ammo spawn amaount increased to 15 (from 10)
  - Bullet speed decreased to 0.16 (from 0.35)
  - Max bullet distance decreased to 48 (from 64)

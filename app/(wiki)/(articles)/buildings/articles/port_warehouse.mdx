...
# Loot & More
The Port Warehouse contains a bunch of crates, barrels, and boxes, some forklifts, and a Flint crate in one corner.

# Tips
- Be careful of the barrels inside the Port Warehouse, as an opponent could destory them when you are distracted and kill you.

...
- It has a higher DPS than the <Link href="weapons/guns/ak47">AK-47</Link> making it an effective counter, especially in close quarters where spread matters less
...
## Countering
- While you can rush with a high DPS close range weapon such as a <Link href="/weapons/guns/micro_uzi">Micro Uzi</Link> to counter an AUG user, be mindful that the AUG can
...
# Obtaining
The AUG is a very common gun, being more common than even the <Link href="weapons/guns/ak47">AK-47</Link>. It can be found in many crates and even commonly as ground loot.
